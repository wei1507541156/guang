package com.work.light.alarm.service;
...
import com.work.light.R;
import com.work.light.alarm.receiver.AlarmReceiver;
import com.work.light.alarm.sharedpreferences.SharedpreferencesUtil;
import com.work.light.alarm.widget.AlarmWidget;
...
public class AlarmService extends Service {
    ...
    private void init() {
        ...
        sender = PendingIntent.getBroadcast(this, hour + minute + second, intent, PendingIntent.FLAG_CANCEL_CURRENT);
...
//                    break;
    ...
    private void startRemoteService() {
        ...
        intent.setAction("com.work.light.remote_service");
        startService(intent);
    }
